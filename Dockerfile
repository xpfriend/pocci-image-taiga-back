...
ENV GIT_VERSION 2.8.5-r0
ENV JPEG_DEV_VERSION 8-r6
ENV LIBXML2_DEV_VERSION 2.9.4-r2
ENV LIBXSLT_DEV_VERSION 1.1.29-r1
ENV LIBFFI_DEV_VERSION 3.2.1-r2
ENV NETCAT_VERSION 1.89-r2
ENV POSTGRESQL_DEV_VERSION 9.5.6-r0
ENV LINUX_HEADERS_VERSION 4.4.6-r1
ENV TAIGA_BACK_VERSION 74a8e8e365ea167d0b40da38d64a3e52e6bf2b3f
